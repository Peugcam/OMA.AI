...
**ESTRUTURA:**
- Abertura impactante com problema
- Apresentação da solução
- Demonstração de features
- Depoimentos/resultados
- Call-to-action forte

**ESTILO:** Moderno, dinâmico, profissional
**TOM:** Entusiasmado mas confiável""",
        "duration": "30",
        "audience": "Profissionais de tecnologia, early adopters",
        "style": "modern",
        "tone": "enthusiastic",
    ...
    "Educacional": {
        "title": "Tutorial: Como Usar IA no Dia a Dia",
        "description": """Vídeo educacional explicando conceitos de forma simples.

**ESTRUTURA:**
- Introdução do problema/tema
- Explicação passo a passo
- Exemplos práticos
- Dicas importantes
- Conclusão e próximos passos

**ESTILO:** Didático, acessível
**TOM:** Amigável e informativo""",
        "duration": "45",
        "audience": "Público geral, iniciantes",
        "style": "educational",
        "tone": "friendly",
        "cta": "Aprenda mais no nosso curso!"
    },

    "Marketing/Vendas": {
        "title": "Oferta Especial - Não Perca!",
        "description": """Vídeo promocional com urgência e valor.
...
**ESTILO:** Energético, persuasivo
**TOM:** Urgente mas não agressivo""",
        "duration": "20",
        "audience": "Potenciais clientes",
        "style": "promotional",
        "tone": "urgent",
    ...
    "Institucional": {
        "title": "Nossa Empresa - Missão e Valores",
        "description": """Vídeo institucional sobre a empresa.
...
**ESTILO:** Profissional, inspirador
**TOM:** Confiante e acolhedor""",
        "duration": "60",
        "audience": "Stakeholders, parceiros, clientes",
        "style": "corporate",
        "tone": "professional",
